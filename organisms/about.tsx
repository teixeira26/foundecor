...
export default function About({}: Props) {
  return (
    ...
    <article className="text-center opacityScrollAnimation">
      ...
      <div className="flex justify-center py-4 bg-[#ff000050] w-[120px] h-[120px] rounded-[5px] z-10 items-center absolute rotate-45"></div>
        <div className="flex justify-center py-4 bg-[#ff000090] w-[112px] h-[112px] rounded-[5px] z-20 items-center absolute rotate-45"></div>
        <div className="flex justify-center py-4 bg-[#ff0000] w-[104px] h-[104px] rounded-[5px] z-30 items-center absolute rotate-45"></div>
